...
//навигация блога
    var blog = function(){
        ...
        blognav_items[1].classList.add('blognav__item--active');
            ...
            itemActive: function(scrollTop){
                for (var i = itemsNum; i >= 0; i--){                   
                    if(coords[i]<scrollTop){
                        ...
                        if(!blognav_items[i+1].classList.contains('blognav__item--active')){
                            blognav_items[i+1].classList.add('blognav__item--active');
                        }
